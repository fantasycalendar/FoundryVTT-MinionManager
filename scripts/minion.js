  ...
  Hooks.on("midi-qol.preDamageRoll", async (workflow) => {
	...
	Hooks.on("midi-qol.preDamageRollComplete", async (workflow) => {
	  ...
	  await Dialog.confirm({
	    "title": "MINIONMANAGER.Dialogs.OverkillDamage.Title",
	    "content": `
